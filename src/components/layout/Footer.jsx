    ...
    <footer className='relative bg-black overflow-hidden border-t border-white/10'>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-12 mb-12">
          ...
          <FadeIn delay={0}>
            <div>
              <h3 className="text-3xl font-bold bg-linear-to-r from-primary/80 via-prima' to-primary/80 bg-clip-text text-transparent mb-4">
          ...
          <FadeIn delay={100}>
            <div>
              <h4 className="text-white font-semibold mb-6 text-lg">Quick Links
              </h4>
          ...
          <FadeIn delay={200}>
            <div>
              ...
              <p className="text-white/60 text-sm mb-6 leading-relaxed">Let's connect and create something together.</p>
              <div className="flex flex-wrap gap-3">
                {Object.entries(SOCIAL_LINKS).map(([platform,url]) => {
                  ...
                  return Icon ? (
                    ...
                    >
                      <Icon className='w-5 h-5 text-white/60 group-hover:text-primary transition-all duration-300' />
                      <div className='absolute inset-0 bg-linear-to-r from-primary/0 to-primary/0 group-hover:from-primary/10 group-hover:to-primary/5 rounded-xl transition-all duration-300 pointer-events-none'/>
                    </a>
                  ):null; 
                })}
              </div>
