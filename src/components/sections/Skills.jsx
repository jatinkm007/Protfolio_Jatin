...
const Skills = () => {
    ...
    const getLevelColor = (level) => {
        ...
        return colors[level] || 'default-level';
    }
                            ...
                            >
                                ...
                                <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 group">
                                    ...
                                    <div className="flex items-center gap-3 mb-6 pb-4 border-b border-white/10">
                                        <div className="w-1 h-8 bg-linear-to-r from-primary/30 to-primary/10 rounded-full"></div>
                                            ...
                                            return (
                                                ...
                                                <div key={skill.id} className="space-y-2">
                                                    ...
                                                    <div className="relative h-1.5 bg-white/5 rounded-full overflow-hidden">
                                                        ...
                                                        <div className="absolute left-0 top-0 h-full bg-linear-to-r from-primary/10 to-primary/80 rounded-full transition-all duration-1000 ease-out"
                                                            style={{
                                                                width: `${proficiency}%`
                                                            }}
                                                        >
