...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        setStatus({ type: 'success', message: 'Message sent successflly! I\'ll get back to you soon.' });
                ...
                <FadeIn delay={0}>
                    <div className="text-center mb-16">
                        ...
                        <p className='text-lg text-white/60 max-w-2xl mx-auto'>
                            Have a proper project in mind? Let's do it together...
                        </p>
                    </div>
                </FadeIn>
                            ...
                            <form onSubmit={handleSubmit} className='space-y-6'>
                                <div>
                                    ...
                                    <input type="text"
                                        ...
                                        className='w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:primary/50 transition-all duration-300'
                                ...
                                <div>
                                    ...
                                    <textarea name="message" id="message"
                                        ...
                                        onChange={handleChange}
                                        rows={5}
                                        className='w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:primary/50 transition-all duration-300 resize-none'
                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <p className='text-white/60 leading-relaxed'>
                                    I'm always open to new opportunities, freelance projects, or just a friendly chat about tech. Drop me a message and I'll get back to you within 24 hours.
                                </p>
                            </div>
