...
const Services = () => {
  return (
    <section id='services' className='relative py-20 bg-black overflow-hidden'>
        <div className="absolute inset-0 overflo-hidden">
        ...
        style={{
            backgroundImage:`
            linear-graddient(to right, white 1px, transparent 1px)
            linear-graddient(to bottom, white 1px, transparent 1px)
            `,
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:-px-8">
            <FadeIn delay={0}>
                <div className="text-center mb-16">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border-primary/30 rounded-full mb-4">
                        <Wrench className='w-4 h-4 text-primary'/>
                        <span className='text-sm text-primary trackind-wider uppercase'>What I offer</span>
                    </div>
                    <h2 className='text-4xl lg:text-5xl font-normal text-white mb-4 max-w-2xl mx-auto'>
                        Turning your ideas into real, working products.
                    </h2>
                    <p className='text-lg text-white/60 max-w-xl mx-auto'>I build fast, responsive, and scalable web applications — from landing pages to full-stack MERN products — tailored to your exact needs.</p>
                </div>
            </FadeIn>
                ...
                {services.slice(0,2).map((service,index) => {
                    ...
                    return(
                        <FadeIn key={service.id} delay={100 + index * 100 }>
                            <div className="group relative bg-white/5 border-white/10 rounded-3xl p-8 hover:border-primary/30 transition-all duration-300 h-full min-h-[280px] flex flex-col">
                                <div className="mb-6">
